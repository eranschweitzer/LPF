...
%% inputs
casename = 'case118';%'case3375wp';%'case1888rte';%'case24_ieee_rts';%'case3375wp';%'case1354pegase';%'case6470rte';%'case13659pegase';%'case_ACTIVSg2000';%%;%'case6470rte'%'case_ACTIVSg10k';
%% initializations
% define_constatns;
